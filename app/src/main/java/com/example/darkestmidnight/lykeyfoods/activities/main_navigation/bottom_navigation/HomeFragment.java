...
import com.example.darkestmidnight.lykeyfoods.helpers.async.GetHomePosts;
...
public class HomeFragment extends Fragment {
    ...
    static String APIUrl = "http://192.168.1.4:8000/api/home/";
    ...
    public void onViewCreated(View view, Bundle savedInstanceState){
        getHomePosts = new GetHomePosts(getContext(), getActivity());
        getHomePosts.execute(APIUrl);
    }
